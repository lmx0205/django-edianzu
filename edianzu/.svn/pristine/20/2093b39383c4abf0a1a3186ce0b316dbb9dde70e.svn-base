...
class Order(models.Model):
    ...
    user = models.ForeignKey(
        UserProfile, verbose_name='客户', null=True, on_delete=models.CASCADE)
...
class OrderDetail(models.Model):
    order = models.ForeignKey(
        Order, verbose_name='所属订单', on_delete=models.CASCADE)
    cart = models.ForeignKey(Cart, verbose_name='购物车产品',
